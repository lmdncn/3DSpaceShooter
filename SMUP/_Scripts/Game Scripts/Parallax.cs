...
/// <summary>
/// The background particles moving
/// </summary>
public class Parallax : MonoBehaviour
{
    ...
    /// <summary>
    /// Make the particles in the right area
    /// </summary>
    void Start()
    {
    ...
    {
        float tY, tX = 0;
        tY = Time.time * scrollSpeed % panelHt + (panelHt * 0.5f); //flying by
        if (poi != null)
        {
            tX = -poi.transform.position.x * motionMult; //move is sideways abit when hero moves sideways
        }
        // Position panels[0]
